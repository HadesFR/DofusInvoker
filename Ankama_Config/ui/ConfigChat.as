package Ankama_Config.ui
{
   ...
   public class ConfigChat extends ConfigUi
   {
      ...
      public function main(args:*) : void
      {
         ...
         properties.push(new ConfigProperty("btn_useAdvancedSpellTooltips","useAdvancedSpellTooltips","dofus"));
         init(properties);
      ...
      private function initChatOptions() : void
      {
         ...
         var serverLangs:Object = sysApi.getCurrentServer().community.supportedLangIds;
