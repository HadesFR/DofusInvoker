package Ankama_Tutorial.ui
{
   ...
   public class SubhintEditorUi
   {
      ...
      private function onSubhintEditorUpdated(data:Subhint) : void
      {
         this.subhintEditorUpdated(data,true);
      }
      
      public function subhintEditorUpdated(data:Subhint, withInspector:Boolean = false) : void
      {
         ...
         if(withInspector)
         {
            ...
            {
               data.hint_parent_uid = data.hint_parent_uid + ("_" + uiRoot.uiClass.currentTabName);
            }
      ...
      private function updateInput(input:Input, increase:Boolean) : void
      {
         ...
         if(increase)
         {
            ...
            if(currentValue < limitValue)
            {
               ...
               currentValue++;
               this._increaseSpeedValue = this._increaseSpeedValue + 2;
      ...
      private function getAllSubhintsInUisOpened() : void
      {
         ...
         this.btn_prevSubhint.disabled = true;
         this.allSubhintsInUisOpened = new Array();
      ...
      private function formatText(text:String) : String
      {
         ...
         var textTt:String = text.replace(regexp,"\n");
         return textTt;
      }
