package Ankama_Tutorial
{
   ...
   import Ankama_Tutorial.ui.GameGuide;
   import Ankama_Tutorial.ui.Guidebook;
   ...
   public class Tutorial extends Sprite
   {
      ...
      private var include_Guidebook:Guidebook;
      
      private var include_GameGuide:GameGuide;
      ...
      private function onOpenGuidebook(tab:String, params:Object = null) : void
      {
         ...
         else
         {
            ...
            if(guidebookUi.uiClass.getCurrentTab() == tab && tab == EnumTab.GUIDEBOOK_GAME_GUIDE)
            {
