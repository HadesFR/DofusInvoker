package com.ankama.haapi.client.model
{
   public class GameActionsDefinition
   {
      ...
      public function toString() : String
      {
         ...
         str = str + (" (restriction_id: " + this.restriction_id + ")");
         str = str + (" (actions: " + this.actions + ")");
         str = str + (" (online_date: " + this.online_date + ")");
         str = str + (" (offline_date: " + this.offline_date + ")");
         str = str + (" (added_date: " + this.added_date + ")");
         str = str + (" (added_account_id: " + this.added_account_id + ")");
         str = str + (" (modified_date: " + this.modified_date + ")");
         str = str + (" (modified_account_id: " + this.modified_account_id + ")");
         str = str + (" (available_date: " + this.available_date + ")");
         str = str + (" (definition_lang: " + this.definition_lang + ")");
         str = str + (" (definition_title: " + this.definition_title + ")");
         str = str + (" (definition_description: " + this.definition_description + ")");
         return str;
      }
   }
}
