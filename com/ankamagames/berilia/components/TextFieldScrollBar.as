package com.ankamagames.berilia.components
{
   ...
   public class TextFieldScrollBar extends GraphicContainer implements UIComponent
   {
      ...
      public function scrollText(scrollDiff:int = 0) : void
      {
         ...
         this._interScroll = this._interScroll + scrollDiff;
         ...
         {
            this._interScroll = this._interScroll - this._nbLines[this._lines[this._scroll]];
      ...
      public function scrollAtEnd() : void
      {
         ...
         if(selectionBegin != selectionEnd)
         {
            ...
            {
               addedLines = addedLines + this._nbLines[this._lines[i]];
            }
            for(i = 0; i < addedLines + this._maxInterScroll - oldMaxInterScroll + this._interScroll; i++)
            {
               nbCharDiffSelectionBegin = nbCharDiffSelectionBegin + this._label.textfield.getLineLength(i);
            }
      ...
      public function removeLastText() : void
      {
         ...
         this.textFieldNumLines = this.textFieldNumLines - this._nbLines[removedText];
         var selectionBegin:int = this._label.textfield.selectionBeginIndex;
         var selectionEnd:int = this._label.textfield.selectionEndIndex;
      ...
      public function addTextLength(text:String) : void
      {
         ...
         this.textFieldNumLines = this.textFieldNumLines + this._nbLines[text];
      }
      ...
      private function updateMaxScroll() : void
      {
         ...
         {
            i--;
            LinesShown = LinesShown + this._nbLines[this._lines[i]];
         }
      ...
      private function drawScrollBar() : void
      {
         ...
         {
            ytemp = ytemp + this._nbLines[this._lines[i]];
         }
      ...
      private function get remainingScrollableLines() : int
      {
         ...
         {
            total = total + this._nbLines[this._lines[i]];
         }
