package com.ankamagames.berilia.components
{
   ...
   public class Input extends Label implements UIComponent
   {
      ...
      private var _inputHistory:Vector.<InputEntry#1559>;
      ...
      public function Input()
      {
         ...
         this._inputHistory = new Vector.<InputEntry#1559>(0);
      ...
      private function addHistory(pText:String) : void
      {
         ...
         var entry:InputEntry = new InputEntry#1559(pText,hyperlinkCodes);
...
class InputEntry#1559
{
   ...
   function InputEntry#1559(pText:String, pHyperlinkCodes:Vector.<String>)
   {
      super();
      this._text = pText;
