package com.ankamagames.berilia.components
{
   ...
   public class TextAreaInput extends TextArea implements FinalizableUIComponent
   {
      ...
      private var _inputHistory:Vector.<InputEntry#7467>;
      ...
      public function TextAreaInput()
      {
         ...
         this._inputHistory = new Vector.<InputEntry#7467>(0);
      ...
      private function addHistory(pText:String) : void
      {
         ...
         var entry:InputEntry = new InputEntry#7467(pText,hyperlinkCodes);
...
class InputEntry#7467
{
   ...
   function InputEntry#7467(pText:String, pHyperlinkCodes:Vector.<String>)
   {
      super();
      this._text = pText;
