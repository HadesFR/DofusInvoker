package com.ankamagames.berilia.components
{
   ...
   public class ChatComponent extends GraphicContainer implements UIComponent, IRectangle, FinalizableUIComponent
   {
      ...
      private var _smilies:Vector.<Smiley#534>;
      ...
      public function initSmileyTab(uri:String, data:Object) : void
      {
         ...
         this._smilies = new Vector.<Smiley#534>();
         for each(t in data)
         {
            if(t.triggers != null && t.triggers.length > 0)
            {
               smiley = new Smiley#534(t.gfxId);
      ...
      private function getSmileyFromText(sTxt:String) : Smiley#534
      {
...
class Smiley#534
{
   ...
   function Smiley#534(pId:String)
   {
      super();
      this.pictoId = pId;
      this.position = -1;
