package com.ankamagames.atouin.renderers
{
   ...
   public class MapRenderer extends EventDispatcher
   {
      ...
      public function MapRenderer(container:DisplayObjectContainer, elements:Elements)
      {
         ...
         this._gfxSubPathJpg = Atouin.getInstance().options.getOption("jpgSubPath");
         this._gfxSubPathPng = Atouin.getInstance().options.getOption("pngSubPath");
         this._gfxPathPngOverride = Atouin.getInstance().options.getOption("pngPathOverride");
         this._particlesPath = Atouin.getInstance().options.getOption("particlesScriptsPath");
         this._extension = Atouin.getInstance().options.getOption("mapPictoExtension");
      ...
      public function render(dataContainer:DataMapContainer, forceReloadWithoutCache:Boolean = false, renderId:uint = 0, renderFixture:Boolean = true, displayWorld:Boolean = true) : void
      {
         ...
         this._debugLayer = Atouin.getInstance().options.getOption("debugLayer");
