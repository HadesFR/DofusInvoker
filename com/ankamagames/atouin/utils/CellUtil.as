package com.ankamagames.atouin.utils
{
   ...
   public class CellUtil
   {
      ...
      {
         var cellSprite:Sprite = InteractiveCellManager.getInstance().getCell(p.cellId);
         var point:Point = new Point(!!pivotInCenter?Number(cellSprite.x + cellSprite.width / 2):Number(cellSprite.x),!!pivotInCenter?Number(cellSprite.y + cellSprite.height / 2):Number(cellSprite.y));
         return point;
      }
