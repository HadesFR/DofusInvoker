package com.ankamagames.dofus.logic.game.common.misc
{
   ...
   public class Inventory
   {
      ...
      public function getItem(uid:int) : ItemWrapper
      {
         ...
         {
            return (this._itemsDict[uid] as ItemSet#518).item;
         }
         return null;
      }
      ...
      {
         var objectUid:* = null;
         var currentItemWrapper:ItemWrapper = null;
      ...
      public function initializeFromObjectItems(items:Vector.<ObjectItem>) : void
      {
         ...
         for(i = 0; i < l; i++)
         {
            ...
            this._itemsDict[item.objectUID] = new ItemSet#518(iw);
            list.push(iw);
         }
      ...
      protected function addItemToViews(itemSet:ItemSet#518) : void
      {
      ...
      protected function modifyItemFromViews(itemSet:ItemSet#518, oldItem:ItemWrapper) : void
      {
         var mask:int = 0;
         var view:IInventoryView = null;
         var quantity:int = 0;
      ...
      protected function removeItemFromViews(itemSet:ItemSet#518) : void
      {
         var view:IInventoryView = null;
         for each(view in this._views)
         {
...
class ItemSet#518
{
   ...
   function ItemSet#518(iw:ItemWrapper)
   {
      super();
      this.item = iw;
   }
