package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class PlayedCharacterUpdatesFrame implements Frame
   {
      ...
      public function process(msg:Message) : Boolean
      {
         ...
         var playerTemporisSpellsDict:Dictionary = null;
            ...
            case msg is ForgettableSpellListUpdateMessage:
               ...
               else
               {
                  ...
                  if(!StoreDataManager.getInstance().getData(ds,FORGETTABLE_SPELL_FIRST_NOTIF_NAME))
                  {
                     ...
                     NotificationManager.getInstance().addButtonToNotification(nid,I18n.getUiText("ui.temporis.popupFirstSpellAddedButton"),"OpenTemporisSpellsUiAction");
