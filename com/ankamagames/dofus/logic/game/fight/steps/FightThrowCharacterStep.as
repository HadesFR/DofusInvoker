package com.ankamagames.dofus.logic.game.fight.steps
{
   ...
   public class FightThrowCharacterStep extends AbstractSequencable implements IFightStep
   {
      ...
      override public function start() : void
      {
         ...
         var carryingEntityTiphonSprite:TiphonSprite = carryingEntity as TiphonSprite;
         if(carryingEntityTiphonSprite !== null)
         {
            carryingEntityTiphonSprite.removeAnimationModifierByClass(CarrierAnimationModifier);
         }
         this._throwSubSequence = new SerialSequencer(FightBattleFrame.FIGHT_SEQUENCER_NAME);
