package com.ankamagames.dofus.logic.game.roleplay.types
{
   ...
   public class RoleplayTeamFightersTooltipInformation
   {
      ...
      public var fighters:Vector.<Fighter#515>;
      ...
      public function RoleplayTeamFightersTooltipInformation(pFightTeam:FightTeam)
      {
         ...
         this.fighters = new Vector.<Fighter#515>();
         ...
         for(i = 0; i < len; i++)
         {
            ...
            switch(true)
            {
               case fightMemberInfo is FightTeamMemberCharacterInformations:
                  ...
                  fighter = new Fighter#515(fightMemberInfo.id,(fightMemberInfo as FightTeamMemberCharacterInformations).name,(fightMemberInfo as FightTeamMemberCharacterInformations).level,allianceTag);
                  break;
               case fightMemberInfo is FightTeamMemberMonsterInformations:
                  ...
                  fighter = new Fighter#515(fightMemberInfo.id,monsterName,monsterLevel);
                  break;
               case fightMemberInfo is FightTeamMemberTaxCollectorInformations:
                  ...
                  fighter = new Fighter#515(fightMemberInfo.id,taxCollectorName,taxCollectorLevel);
                  break;
      ...
      private function getCompanionFighter(pFighter:Fighter#515, pCompanionId:int, pCompanionGenericId:int) : Fighter#515
      {
         return new Fighter#515(pCompanionId,I18n.getUiText("ui.common.belonging",[Companion.getCompanionById(pCompanionGenericId).name,pFighter.name]),pFighter.level,pFighter.allianceTagName);
      }
   }
}
...
class Fighter#515
{
   ...
   function Fighter#515(pId:Number, pName:String, pLevel:uint, pAllianceTagName:String = null)
   {
      super();
      this._id = pId;
      this.name = pName;
