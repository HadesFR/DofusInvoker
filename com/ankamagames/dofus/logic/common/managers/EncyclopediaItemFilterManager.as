      ...
      override public function dataInit(specificFilters:Array = null) : void
      {
         ...
         switch(_currentCategory)
         {
            ...
            case SKIN_CATEGORY:
               ...
               {
                  setSubFilters(DataEnum.ITEM_SUPERTYPE_LIVING_ITEMS,DataEnum.ITEM_SUPERTYPE_LIVING_ITEMS,_currentUi.uiClass.uiApi.getText("ui.encyclopedia.cosmeticCategory"));
               }
