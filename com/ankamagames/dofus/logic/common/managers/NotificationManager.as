package com.ankamagames.dofus.logic.common.managers
{
   ...
   public class NotificationManager
   {
      ...
      private var _notificationList:Vector.<Notification#270>;
      
      public function NotificationManager()
      {
         super();
         this._notificationList = new Vector.<Notification#270>();
      }
      ...
      {
         var notif:Notification = new Notification#270();
         notif.title = pTitle;
      ...
      public function sendNotification(notificationId:int = -1) : void
      {
         ...
         {
            this.openNotification(this._notificationList[notificationId] as Notification#270);
      ...
      private function getNotification(pId:uint) : Notification#270
      {
         return this._notificationList[pId];
      }
      
      private function openNotification(pNotif:Notification#270) : void
      {
