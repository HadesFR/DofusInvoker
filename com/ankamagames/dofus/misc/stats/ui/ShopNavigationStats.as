package com.ankamagames.dofus.misc.stats.ui
{
   ...
   public class ShopNavigationStats implements IUiStats, IHookStats
   {
      ...
      public function onHook(pHook:String, pArgs:Array) : void
      {
         ...
         var paymentChoiceArticle:DofusShopObject = null;
         var validCodeArticle:DofusShopObject = null;
         ...
         switch(pHook)
         {
            ...
            case ExternalGameHookList.DofusShopDirectBuyClick:
               ...
               break;
            case ExternalGameHookList.DofusShopValidPaymentChoice:
               ...
               break;
            case ExternalGameHookList.DofusShopValidCode:
