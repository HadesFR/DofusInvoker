package com.ankamagames.dofus.misc.utils
{
   ...
   public class SubhintInspector
   {
      ...
      private var _lastTarget:Vector.<InteractiveItem#192>;
      
      private var _underPoint:Point;
      
      private var _currentShortCut:ShortcutItem#192;
      ...
      private function onMouseMove(e:MouseEvent) : void
      {
         ...
         {
            this._currentShortCut = new ShortcutItem#192("Freeze",Keyboard.S,this.freeze,true);
         }
      ...
      private function findElements(target:DisplayObject) : Vector.<InteractiveItem#192>
      {
      ...
      private function cast(target:DisplayObject) : InteractiveItem#192
      {
         var currentItem:InteractiveItem = null;
         switch(true)
         {
            ...
            case target is GraphicContainer:
               currentItem = new InteractiveItemUi#192();
...
class ShortcutItem#192
{
   ...
   function ShortcutItem#192(legend:String, key:uint, callback:Function, shift:Boolean)
   {
      super();
      this.legend = legend;
      this.key = key;
...
class InteractiveItem#192
{
   ...
   public var shortcut:ShortcutItem#192;
...
class InteractiveItemUi#192 extends InteractiveItem#192
{
    
   
   function InteractiveItemUi#192()
   {
      super();
   }
