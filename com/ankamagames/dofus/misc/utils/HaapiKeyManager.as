package com.ankamagames.dofus.misc.utils
{
   ...
   public class HaapiKeyManager extends EventDispatcher implements IDestroyable
   {
      ...
      private var _apiKeyExpirationTimer:Timer;
      ...
      public function HaapiKeyManager()
      {
         ...
         this._apiKeyExpirationTimer = new Timer(ONE_HOUR_IN_MS,1);
         this._retryTimer = new Timer(500,1);
         super();
      ...
      public function onTimerEnd(pEvent:TimerEvent) : void
      {
         ...
         {
            this._retryTimer.reset();
            removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTimerEnd);
