package com.ankamagames.dofus.misc.utils
{
   ...
   public class Inspector
   {
      ...
      private var _lastTarget:Vector.<InteractiveItem#563>;
      
      private var _currentShortCut:Vector.<ShortcutItem#563>;
      ...
      private function onMouseMove(e:MouseEvent) : void
      {
         ...
         if(this._lastTarget.length)
         {
            ...
            this._currentShortCut = !!this._lastTarget[0].shortcuts?this._lastTarget[0].shortcuts.concat():new Vector.<ShortcutItem#563>();
            this._currentShortCut.unshift(new ShortcutItem#563("Copier toutes les informations",Keyboard.C,function():void
            {
               var tf:* = new TextField();
               tf.htmlText = rawTooltipStr.split("<br/>").join("\n");
               Clipboard.generalClipboard.setData(ClipboardFormats.TEXT_FORMAT,tf.text);
            },true,false,false));
            this._currentShortCut.unshift(new ShortcutItem#563("Activer l\'inspection avancée",Keyboard.Z,function():void
            {
      ...
      private function findElements(target:DisplayObject) : Vector.<InteractiveItem#563>
      {
         var currentItem:InteractiveItem = null;
         var result:Vector.<InteractiveItem> = new Vector.<InteractiveItem#563>();
         var ind:String = "";
      ...
      private function findSameLevelElements() : Vector.<InteractiveItem#563>
      {
         var currentItem:InteractiveItem = null;
         var item:DisplayObject = null;
         var result:Vector.<InteractiveItem> = new Vector.<InteractiveItem#563>();
      ...
      private function cast(target:DisplayObject) : InteractiveItem#563
      {
         var currentItem:InteractiveItem = null;
         switch(true)
         {
            ...
            case target is GraphicContainer:
               currentItem = new InteractiveItemUi#563();
...
class ShortcutItem#563
{
   ...
   function ShortcutItem#563(legend:String, key:uint, callback:Function, ctrl:Boolean, shift:Boolean, alt:Boolean)
   {
      super();
      this.legend = legend;
      this.key = key;
...
class InteractiveItem#563
{
   ...
   public var shortcuts:Vector.<ShortcutItem#563>;
   
   public var target:DisplayObject;
   
   function InteractiveItem#563()
   {
      super();
   }
   
   public function highlight(index:uint, elements:Vector.<InteractiveItem#563>) : void
   {
   }
...
class InteractiveItemUi#563 extends InteractiveItem#563
{
    
   
   function InteractiveItemUi#563()
   {
      super();
      shortcuts = Vector.<ShortcutItem#563>([new ShortcutItem#563("Cmd click test fonctionnel",Keyboard.Q,function():void
      {
         toClipboard("click( UiHelper.get(\"" + GraphicContainer(target).getUi().uiData.name + "\"), \"" + GraphicContainer(target).customUnicName + "\");");
      },true,true,false),new ShortcutItem#563("Cmd son survol",Keyboard.S,function():void
      {
      ...
      },true,true,false),new ShortcutItem#563("Cmd son click",Keyboard.X,function():void
      {
         toClipboard("/adduisoundelement " + GraphicContainer(target).getUi().uiData.name + " " + target.name + " onRelease [ID_SON]");
      },true,true,false),new ShortcutItem#563("Cmd inspecter element",Keyboard.A,function():void
      {
         toClipboard("/inspectuielement " + GraphicContainer(target).getUi().uiData.name + " " + target.name);
      },true,true,false)]);
   }
   
   override public function highlight(index:uint, elements:Vector.<InteractiveItem#563>) : void
   {
      ...
      for each(elem in elements)
      {
         ...
         if(elem is InteractiveItemUi#563 && elem.target != target)
         {
            firstUi = false;
            break;
         }
...
class InteractiveItemCell extends InteractiveItem#563
{
...
class InteractiveItemEntity extends InteractiveItem#563
{
      ...
      if(info)
      {
         switch(true)
         {
            case info is GameRolePlayNpcInformations:
               ...
               shortcuts.push(new ShortcutItem#563("Ouvrir l\'admin lite de ce PNJ",Keyboard.A,function():void
               {
...
class InteractiveItemElement extends InteractiveItem#563
{
...
class InteractiveItemMapBorder extends InteractiveItem#563
{
   ...
   override public function tooltip() : String
   {
      ...
      var str:* = "<b><font color=\'#40BD00\'>Bord de map " + DirectionsEnum.getNameFromDirection(mb.direction) + " (" + prc + "%)</font></b>";
      return str;
   }
}
