package com.ankamagames.dofus.misc.lists
{
   ...
   public class ExternalGameHookList
   {
      ...
      public static const DofusShopValidPaymentChoice:String = "DofusShopValidPaymentChoice";
      
      public static const DofusShopValidCode:String = "DofusShopValidCode";
      ...
      public static const DofusShopOneClickTokens:String = "DofusShopOneClickTokens";
      
      public static const DofusShopOneInvalidCode:String = "DofusShopOneInvalidCode";
      ...
      public static function initHooks() : void
      {
         ...
         Hook.createHook(DofusShopValidPaymentChoice);
         Hook.createHook(DofusShopValidCode);
         ...
         Hook.createHook(DofusShopOneClickTokens);
         Hook.createHook(DofusShopOneInvalidCode);
