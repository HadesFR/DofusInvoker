package com.ankamagames.dofus.misc.lists
{
   ...
   public class ApiActionList
   {
      ...
      public static const OpenIdols:DofusApiAction = new DofusApiAction("OpenIdolsAction",OpenIdolsAction);
      
      public static const CloseIdols:DofusApiAction = new DofusApiAction("CloseIdolsAction",CloseIdolsAction);
      
      public static const IdolSelectRequest:DofusApiAction = new DofusApiAction("IdolSelectRequestAction",IdolSelectRequestAction);
      ...
      public static const ChallengeTargetsListRequest:DofusApiAction = new DofusApiAction("ChallengeTargetsListRequestAction",ChallengeTargetsListRequestAction);
      ...
      public static const IdolsPresetSaveRequest:DofusApiAction = new DofusApiAction("IdolsPresetSaveRequestAction",IdolsPresetSaveRequestAction);
      ...
      public static const ShopOneClickBuyRequest:DofusApiAction = new DofusApiAction("ShopOneClickBuyRequestAction",ShopOneClickBuyRequestAction);
      
      public static const ShopOneClickValidateOrderRequest:DofusApiAction = new DofusApiAction("ShopOneClickValidateOrderRequestAction",ShopOneClickValidateOrderRequestAction);
      
      public static const ShopOneClickSendCodeRequest:DofusApiAction = new DofusApiAction("ShopOneClickSendCodeRequestAction",ShopOneClickSendCodeRequestAction);
      ...
      public static const OpenTemporisSpellsUi:DofusApiAction = new DofusApiAction("OpenTemporisSpellsUiAction",OpenTemporisSpellsUiAction);
