package com.ankamagames.dofus.uiApi
{
   ...
   import com.ankamagames.dofus.datacenter.items.ItemSet#138;
   ...
   import com.ankamagames.dofus.datacenter.notifications.Notification#469;
   ...
   public class DataApi implements IApi
   {
      ...
      {
         return Notification#469.getNotifications();
      }
      ...
      public function getItemSet(id:int) : ItemSet#138
      {
         return ItemSet#138.getItemSetById(id);
      }
      ...
      public function getSmiley(id:uint) : Smiley#96
      {
         return Smiley#96.getSmileyById(id);
      }
      
      public function getAllSmiley() : Array
      {
         return Smiley#96.getSmileys();
      }
      ...
      public function getAllFeatureDescription() : Array
      {
         return FeatureDescription.getFeatureDescriptions();
      }
      
      public function getPopupInformationById(id:int) : PopupInformation
      {
         return PopupInformation.getPopupInformationById(id);
      }
      
      public function getPopupInformations() : Array
      {
         return PopupInformation.getPopupInformations();
      }
   }
}
