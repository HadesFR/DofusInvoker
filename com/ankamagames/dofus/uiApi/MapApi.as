package com.ankamagames.dofus.uiApi
{
   ...
   import com.ankamagames.dofus.types.entities.SearchResult#99;
   ...
   public class MapApi implements IApi
   {
      ...
      private var _searchResult:SearchResult#99;
      ...
      {
         this._searchResult = new SearchResult#99();
      ...
      private function getSearchResultEntry(pId:int, pType:uint, pSearch:String) : Object
      {
         ...
         switch(pType)
         {
            ...
            case MONSTER_SEARCH_TYPE:
               ...
               if(searchResult.resultCode == SearchResult#99.VALID_PARTIAL)
               {
                  this._hasResultsInOtherWorldMap = true;
               }
      ...
      private function getMonsterValidSubAreas(pMonster:Monster) : SearchResult#99
      {
         var subAreasIds:Vector.<int> = null;
         var subArea:SubArea = null;
         var subAreaId:uint = 0;
         var resultCode:int = SearchResult#99.VALID_ALL;
         if(pMonster.subareas.length > 0)
         {
            for each(subAreaId in pMonster.subareas)
            {
               ...
               if(this.isValidSubArea(subArea))
               {
                  ...
                  {
                     resultCode = SearchResult#99.VALID_PARTIAL;
                  }
               }
            }
         }
         this._searchResult.resultData = subAreasIds;
         this._searchResult.resultCode = !subAreasIds && resultCode != SearchResult#99.VALID_PARTIAL?int(SearchResult#99.VALID_NONE):int(resultCode);
         return this._searchResult;
      }
      
      private function getItemValidSubAreas(pItem:Item) : SearchResult#99
      {
         var subAreasIds:Vector.<int> = null;
         var monster:Monster = null;
         ...
         for each(monsterId in pItem.dropMonsterIds)
         {
            ...
            if(monsterSubAreasResult.resultCode == SearchResult#99.VALID_PARTIAL)
            {
               resultCode = SearchResult#99.VALID_PARTIAL;
            }
         }
      ...
      private function getResourceItemValidSubAreaIds(pItem:Item) : SearchResult#99
      {
         var subAreasIds:Vector.<int> = null;
