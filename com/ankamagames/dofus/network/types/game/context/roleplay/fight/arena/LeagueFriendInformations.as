package com.ankamagames.dofus.network.types.game.context.roleplay.fight.arena
{
   ...
   public class LeagueFriendInformations extends AbstractContactInformations implements INetworkType
   {
      ...
      public static const protocolId:uint = 4263;
      ...
      public function initLeagueFriendInformations(accountId:uint = 0, accountName:String = "", playerId:Number = 0, playerName:String = "", breed:int = 0, sex:Boolean = false, level:uint = 0, leagueId:int = 0, totalLeaguePoints:int = 0, ladderPosition:int = 0) : LeagueFriendInformations
      {
