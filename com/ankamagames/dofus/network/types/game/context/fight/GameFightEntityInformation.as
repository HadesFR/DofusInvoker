package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class GameFightEntityInformation extends GameFightFighterInformations implements INetworkType
   {
      ...
      public static const protocolId:uint = 8660;
      ...
      public function initGameFightEntityInformation(contextualId:Number = 0, disposition:EntityDispositionInformations = null, look:EntityLook = null, spawnInfo:GameContextBasicSpawnInformation = null, wave:uint = 0, stats:GameFightMinimalStats = null, previousPositions:Vector.<uint> = null, entityModelId:uint = 0, level:uint = 0, masterId:Number = 0) : GameFightEntityInformation
      {
