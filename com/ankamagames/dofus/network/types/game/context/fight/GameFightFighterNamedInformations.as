package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class GameFightFighterNamedInformations extends GameFightFighterInformations implements INetworkType
   {
      ...
      public function initGameFightFighterNamedInformations(contextualId:Number = 0, disposition:EntityDispositionInformations = null, look:EntityLook = null, spawnInfo:GameContextBasicSpawnInformation = null, wave:uint = 0, stats:GameFightMinimalStats = null, previousPositions:Vector.<uint> = null, name:String = "", status:PlayerStatus = null, leagueId:int = 0, ladderPosition:int = 0, hiddenInPrefight:Boolean = false) : GameFightFighterNamedInformations
      {
