package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class GameFightMonsterInformations extends GameFightAIInformations implements INetworkType
   {
      ...
      public function initGameFightMonsterInformations(contextualId:Number = 0, disposition:EntityDispositionInformations = null, look:EntityLook = null, spawnInfo:GameContextBasicSpawnInformation = null, wave:uint = 0, stats:GameFightMinimalStats = null, previousPositions:Vector.<uint> = null, creatureGenericId:uint = 0, creatureGrade:uint = 0, creatureLevel:uint = 0) : GameFightMonsterInformations
      {
