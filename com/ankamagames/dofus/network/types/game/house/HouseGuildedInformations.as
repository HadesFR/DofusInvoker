package com.ankamagames.dofus.network.types.game.house
{
   ...
   public class HouseGuildedInformations extends HouseInstanceInformations implements INetworkType
   {
      ...
      public function initHouseGuildedInformations(instanceId:uint = 0, secondHand:Boolean = false, isLocked:Boolean = false, ownerName:String = "", price:Number = 0, isSaleLocked:Boolean = false, guildInfo:GuildInformations = null) : HouseGuildedInformations
      {
         super.initHouseInstanceInformations(instanceId,secondHand,isLocked,ownerName,price,isSaleLocked);
