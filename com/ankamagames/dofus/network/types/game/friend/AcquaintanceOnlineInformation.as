package com.ankamagames.dofus.network.types.game.friend
{
   ...
   public class AcquaintanceOnlineInformation extends AcquaintanceInformation implements INetworkType
   {
      ...
      public function initAcquaintanceOnlineInformation(accountId:uint = 0, accountName:String = "", playerState:uint = 99, playerId:Number = 0, playerName:String = "", moodSmileyId:uint = 0, status:PlayerStatus = null) : AcquaintanceOnlineInformation
      {
         super.initAcquaintanceInformation(accountId,accountName,playerState);
