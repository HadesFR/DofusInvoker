package com.ankamagames.dofus.network.types.game.friend
{
   ...
   public class FriendInformations extends AbstractContactInformations implements INetworkType
   {
      ...
      public function initFriendInformations(accountId:uint = 0, accountName:String = "", playerState:uint = 99, lastConnection:uint = 0, achievementPoints:int = 0, leagueId:int = 0, ladderPosition:int = 0) : FriendInformations
      {
