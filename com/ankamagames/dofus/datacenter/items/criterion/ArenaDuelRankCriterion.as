package com.ankamagames.dofus.datacenter.items.criterion
{
   ...
   public class ArenaDuelRankCriterion extends ItemCriterion implements IDataCenter
   {
      ...
      public function ArenaDuelRankCriterion(pCriterion:String)
      {
         super(pCriterion);
      }
      ...
      override public function get text() : String
      {
         ...
         var readableCriterionRef:String = I18n.getUiText("ui.common.pvpDuelRank");
      ...
      {
         var clonedCriterion:ArenaDuelRankCriterion = new ArenaDuelRankCriterion(this.basicText);
      ...
      override protected function getCriterion() : int
      {
         ...
         var rank:int = 0;
         if(frame.arenaRankDuelInfos && frame.arenaRankDuelInfos.rank > rank)
         {
