package com.ankamagames.dofus.modules.utils.pathfinding.world
{
   ...
   public class WorldGraph
   {
      ...
      public function getOutgoingEdgesFromVertex(from:Vertex) : Vector.<Edge#154>
      {
         return this._outgoingEdges[from.UID];
      }
      
      public function getEdge(from:Vertex, dest:Vertex) : Edge#154
      {
      ...
      public function addEdge(from:Vertex, dest:Vertex) : Edge#154
      {
