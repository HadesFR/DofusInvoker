package com.ankamagames.dofus.modules.utils.pathfinding.astar
{
   ...
   public class AStar
   {
      ...
      private static function hasValidTransition(edge:Edge#154) : Boolean
      {
      ...
      private static function hasValidDestinationSubarea(edge:Edge#154) : Boolean
      {
      ...
      private static function callbackWithResult(result:Vector.<Edge#154>) : void
      {
      ...
      private static function buildResultPath(worldGraph:WorldGraph, node:Node) : Vector.<Edge#154>
      {
         var result:Vector.<Edge> = new Vector.<Edge#154>();
