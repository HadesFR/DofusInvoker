   ...
   public class AdministrablePopup extends Popup
   {
      ...
      private function updateIllu() : void
      {
         ...
         if(this._hasImage)
         {
            ...
            this._totalHeight = this._totalHeight + this.tx_illu.height;
         }
         else
         {
      ...
      private function updateText() : void
      {
         ...
         if(this._hasImage)
         {
            this._totalHeight = this._totalHeight + (this.lbl_title.contentHeight + this._margin);
         ...
         else
         {
            ...
            this._totalHeight = this._totalHeight + (lbl_content.contentHeight + this._margin);
      ...
      private function updateItem() : void
      {
         ...
         if(this._hasItemList)
         {
            ...
            this._totalHeight = this._totalHeight + (this.gd_items.anchorY + this.gd_items.contentHeight + this._margin);
      ...
      private function updateButtons() : void
      {
         ...
         this._totalHeight = this._totalHeight + (this.btn_main.contentHeight + this._margin);
         if(this._hasItemList)
         {
      ...
      private function closeMe() : void
      {
         if(uiApi)
         {
            uiApi.unloadUi((uiApi.me() as Object).name);
         }
         if(this._onCloseCallback != null)
         {
            this._onCloseCallback();
