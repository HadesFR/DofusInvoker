package Ankama_Common.ui
{
   ...
   public class IllustratedWithLinkPopup
   {
      ...
      public function main(args:Object) : void
      {
         ...
         this.popup.height = this.popup.height + this.lbl_content.contentHeight;
         ...
         else
         {
            ...
            this.popup.height = this.popup.height + (this.btn_link.anchorY + this.btn_link.contentHeight / 2);
            ...
            if(args.link != "")
            {
               ...
               this.btn_link.width = this.btn_link.width + this.tx_btn_link.width;
               this.lbl_btn_link.x = this.lbl_btn_link.x + this.tx_btn_link.width / 2;
            }
            else
            {
