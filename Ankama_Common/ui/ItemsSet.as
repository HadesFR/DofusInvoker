package Ankama_Common.ui
{
   ...
   public class ItemsSet
   {
      ...
      {
         var eqItem:* = undefined;
         var name:String = null;
         var num:int = 0;
         var i:int = 0;
         var setItem:* = undefined;
         var item1:* = undefined;
         var item2:* = undefined;
         var equip:* = undefined;
      ...
      private function filteredBonus(addObjects:Boolean = false) : Array
      {
         ...
         var bonusLineS:* = undefined;
         var i:int = 0;
         var bonusPack:Object = null;
         ...
         var effectsText:Array = new Array();
         var totalEffects:Array = new Array();
         if(addObjects)
         {
