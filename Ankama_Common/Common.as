package Ankama_Common
{
   ...
   public class Common extends Sprite
   {
      ...
      public function openPopup(title:String, content:String, buttonText:Array, buttonCallback:Array = null, onEnterKey:Function = null, onCancel:Function = null, image:Object = null, largeText:Boolean = false, useHyperLink:Boolean = false, displayBtnIcons:Boolean = true, buttonIcons:Array = null, strata:int = 3) : String
      {
         this._currentPopupNumber++;
      ...
      private function onOpenEvolutiveFeed(itemToFeed:Object) : void
      {
      ...
      private function onShowObjectLinked(item:Object = null) : void
      {
         ...
         var itemTooltipSettings:* = Api.system.getData("itemTooltipSettings",DataStoreEnum.BIND_ACCOUNT) as ItemTooltipSettings;
      ...
      public function createItemBox(name:String, father:GraphicContainer, item:Object, showTheoretical:Boolean = false, ownedItem:Boolean = false) : Object
      {
         if(!item || item == null)
         {
      ...
      public function createRecipesObject(name:String, father:GraphicContainer, subRecipesCtr:Object, jobId:int, skillId:int = 0, matsCountMode:Boolean = false, storage:String = "", jobLevel:int = 0, ingredientsToleranceFilter:int = 8) : Object
      {
         if(!this.uiApi.getUi(name))
         {
