   ...
   public class ZaapSelection
   {
      ...
      public function onRelease(target:Object) : void
      {
         ...
         if(target.name.indexOf("btn_zaapCoord") != -1)
         {
            ...
            flagText = flagText + (" - " + this._componentsList[target.name].areaName + "(" + this._componentsList[target.name].subAreaName + ")" + " (" + this._componentsList[target.name].coord + ")");
         ...
         else
         {
            switch(target)
            {
               ...
               case this.tx_fav:
                  ...
                  {
                     if(currentZaap.subAreaName == this._currentZaap.subAreaName)
                     {
