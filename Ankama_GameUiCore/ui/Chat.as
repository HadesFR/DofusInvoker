package Ankama_GameUiCore.ui
{
   ...
   public class Chat
   {
      ...
      private var _msgQueueTimer:Timer;
      ...
      public function Chat()
      {
         ...
         this._msgQueueTimer = new Timer(50,1);
         super();
      }
      ...
      private function displayHelp(typeToDisplay:String) : void
      {
         ...
         {
            shortcuts = ["focusChat","shiftUp","altValid","shiftValid","ctrlAltValid","autoComplete"];
      ...
      public function onRelease(target:Object) : void
      {
         ...
         var chan:* = undefined;
         var chatChannelTab:Object = null;
         switch(target)
         {
            case this.btn_menu:
               contextMenu = [];
      ...
      public function onKeyUp(event:KeyboardEvent) : void
      {
         ...
         else if(!(event.altKey || event.shiftKey || event.hasOwnProperty("controlKey") && Object(event).controlKey || event.ctrlKey || event.hasOwnProperty("commandKey") && Object(event).commandKey) && event.keyCode == Keyboard.ENTER)
         {
            this.validUiShortcut();
         }
         else
      ...
      public function onUserMessage(msg:ChannelMessage) : void
      {
         ...
         if(msg.author.userId == me)
         {
            ...
            this.displayMessage(ChatActivableChannelsEnum.PSEUDO_CHANNEL_PRIVATE,msg.content,Number(msg.createdTimestamp),"",0,"","",null,friendName,parseInt(otherId),false,false,false,true);
         }
         else
         {
            this.displayMessage(ChatActivableChannelsEnum.PSEUDO_CHANNEL_PRIVATE,msg.content,Number(msg.createdTimestamp),"",Number(msg.author.userId),"",msg.author.name,"","",0,false,false,false,true);
         }
      }
      ...
      {
         var tab:* = undefined;
         var channelsFromData:Object = null;
         var cc:* = undefined;
      ...
      private function autocompleteChat() : void
      {
         ...
         for(var i:int = text.length - 1; i >= 0; )
         {
            if(text.charAt(i) == " ")
            {
