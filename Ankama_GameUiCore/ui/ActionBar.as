package Ankama_GameUiCore.ui
{
   ...
   public class ActionBar extends ContextAwareUi
   {
      ...
      public function onItemRightClick(target:Object, item:Object) : void
      {
         ...
         var spellContextMenu:Object = null;
         ...
         switch(this._sTabGrid)
         {
            case ITEMS_TAB:
               ...
               if(data.usable || data.type == TYPE_BUILD_WRAPPER || data.type == TYPE_SMILEY_WRAPPER || data.type == TYPE_EMOTE_WRAPPER)
               {
                  ...
                  contextMenu.content.unshift(this.modContextMenu.createContextMenuItemObject(this.uiApi.getText("ui.common.use"),this.useItem,[data.id,data.type],!disabled?!data.active:disabled));
               }
      ...
      {
         var spellId:int = 0;
         var isTemporisSpell:Boolean = false;
