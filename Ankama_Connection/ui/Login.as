   ...
   public class Login
   {
      ...
      private function login() : void
      {
         ...
         else
         {
            ...
            if(this.sysApi.isEventMode())
            {
               ...
               this.sysApi.sendAction(new LoginValidationAction([username,"pass",true]));
            }
            else
            {
               ...
               this.sysApi.sendAction(new LoginValidationAction([sLogin,sPass,this.cb_connectionType.selectedItem.type != 0]));
            }
         }
      }
      ...
      private function autoLogin() : void
      {
         if(this._currentMode == GAMEMODE_LOG_IN_ZAAP)
         {
            ...
            this.sysApi.sendAction(new LoginValidationWithTokenAction([]));
         }
      }
