package mx.messaging.messages
{
   ...
   public class AbstractMessage implements IMessage
   {
      ...
      public function writeExternal(output:IDataOutput) : void
      {
         ...
         if(this.body != null)
         {
            flags = flags | BODY_FLAG;
         }
         if(this.clientId != null && this.clientIdBytes == null)
         {
            flags = flags | CLIENT_ID_FLAG;
         }
         if(this.destination != null)
         {
            flags = flags | DESTINATION_FLAG;
         }
         if(this.headers != null)
         {
            flags = flags | HEADERS_FLAG;
         }
         if(this.messageId != null && this.messageIdBytes == null)
         {
            flags = flags | MESSAGE_ID_FLAG;
         }
         if(this.timestamp != 0)
         {
            flags = flags | TIMESTAMP_FLAG;
         }
         if(this.timeToLive != 0)
         {
            flags = flags | TIME_TO_LIVE_FLAG;
         }
         if(this.clientIdBytes != null || this.messageIdBytes != null)
         {
            flags = flags | HAS_NEXT_FLAG;
         }
         output.writeByte(flags);
         flags = 0;
         if(this.clientIdBytes != null)
         {
            flags = flags | CLIENT_ID_BYTES_FLAG;
         }
         if(this.messageIdBytes != null)
         {
            flags = flags | MESSAGE_ID_BYTES_FLAG;
         }
         if(flags != 0)
         {
            output.writeByte(flags);
      ...
      protected final function getDebugString() : String
      {
         ...
         for(i = 0; i < length; i++)
         {
            ...
            result = result + RPCStringUtil.substitute("\n  {0}={1}",name,value);
         }
         return result;
      }
