   ...
   public class BreachBossSelection
   {
      ...
      public function updateBosses(data:*, componentsRef:*, selected:Boolean) : void
      {
         ...
         if(data)
         {
            ...
            {
               componentsRef.lbl_bossName.text = componentsRef.lbl_bossName.text + (" " + this.uiApi.getText("ui.common.and") + " " + this.dataApi.getMonsterFromId(data.bosses[1].genericId).name);
            ...
            if(data.isLocked)
            {
               ...
               componentsRef.lbl_buyRoom.x = componentsRef.lbl_buyRoom.x + toMoveX;
