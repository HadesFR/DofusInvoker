package flashx.textLayout.compose
{
   ...
   public class Parcel
   {
      ...
      private static var edgeCache:Vector.<Edge#587>;
      ...
      private var _left:Edge#587;
      
      private var _right:Edge#587;
      ...
      private function allocateEdge(x:Number) : Edge#587
      {
         if(!edgeCache)
         {
            edgeCache = new Vector.<Edge#587>();
         }
         var edge:Edge = edgeCache.length > 0?edgeCache.pop():new Edge#587();
         edge.initialize(x);
         return edge;
      }
      
      private function deallocateEdge(edge:Edge#587) : void
      {
