package Ankama_Tooltips.ui
{
   ...
   public class WorldRpSignTooltipUi
   {
      ...
      private function setTextBlock(param:Object) : void
      {
         ...
         this.backgroundCtr.width = this.backgroundCtr.width + (this.lbl_text.width + this.lbl_text.anchorX * 2 - 1);
      ...
      public function onTextureReady(target:Object) : void
      {
         switch(target)
         {
            case this.tx_direction:
               this.backgroundCtr.width = 0;
               this.backgroundCtr.height = 0;
               this.backgroundCtr.width = this.backgroundCtr.width + (this.tx_direction.width + this.tx_direction.anchorX * 2 - 1);
               this.backgroundCtr.height = this.backgroundCtr.height + (this.tx_direction.height + this.tx_direction.anchorY * 2 - 1);
               this.setTextBlock(this._param);
