   ...
   public class WorldRpCharacterTooltipUi
   {
      ...
      public function main(oParam:Object = null) : void
      {
         ...
         if(hasGuildInformation)
         {
            ...
            this.lbl_playerName.x = this.lbl_playerName.x + (maxLabel.width - this.lbl_playerName.width) / 2;
            this.lbl_guildName.x = this.lbl_guildName.x + (maxLabel.width - this.lbl_guildName.width) / 2;
            this.lbl_title.x = this.lbl_title.x + (maxLabel.width - this.lbl_title.width) / 2;
         }
         ...
         if(this.lbl_title.text != "")
         {
            ...
            if(hasGuildInformation)
            {
               if(hasAllianceInformation)
               {
                  backgroundWidth = backgroundWidth + (EMBLEM_BACK_WIDTH + (maxLabel != this.lbl_title?8:0));
               }
               else
               {
         ...
         if(hasOrnament)
         {
            ...
            {
               this.tx_back.height = this.tx_back.height + 10;
            }
         }
         else
         {
