package Ankama_Tooltips.ui
{
   ...
   public class TooltipPinableBaseUi
   {
      ...
      public function onRelease(target:Object) : void
      {
         ...
         else if(target == this.btnMenu)
         {
            if(this._params && this._params.data != MountWrapper)
            {
               ...
               {
                  contextMenu = this.menuApi.create(this._params.data.itemWrapper,null,[{"ownedItem":(!!this.inventoryApi.getItemFromInventoryByUID(this._params.data.itemWrapper.objectUID)?true:false)},this.uiApi.me()["name"]]);
               }
               else if(this._params && this._params.data)
               {
                  contextMenu = this.menuApi.create(this._params.data,null,[{"ownedItem":(!!this.inventoryApi.getItemFromInventoryByUID(this._params.data.objectUID)?true:false)},this.uiApi.me()["name"]]);
               }
      ...
      private function _onKeyDown(target:Object, keyCode:uint) : void
      {
      ...
      private function _onMouseShiftClick(target:Object) : void
      {
         _cancelKeyUp = true;
      }
      
      private function _onKeyUp(target:Object, keyCode:uint) : void
      {
         ...
         if(!_cancelKeyUp && keyCode == KEY_PIN && !(this._params.makerParam && this._params.makerParam.hasOwnProperty("unPinnable") && this._params.makerParam.unPinnable) && !_displayedPin[this._params.data])
         {
            ...
            settings.footerText = "";
            if(settings.hasOwnProperty("alwaysAdvanced"))
            {
               settings.advanced = settings.alwaysAdvanced;
               settings.alwaysAdvanced = false;
            }
