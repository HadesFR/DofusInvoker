package Ankama_Tooltips.ui
{
   ...
   public class WorldRpMonstersGroupTooltipUi
   {
      ...
      private function getMonstersGroupData(pStaticInfos:GroupMonsterStaticInformations, pPlayerData:*, pGroupMembersData:Array, pMapRewardRate:int) : MonstersGroupData#483
      {
         ...
         groupData = new MonstersGroupData#483(totalLevel,grp,FormulaHandler.getInstance().xpSolo,FormulaHandler.getInstance().xpGroup);
         return groupData;
      }
...
class MonstersGroupData#483
{
   ...
   function MonstersGroupData#483(pLevel:int, pGroup:Array, pXpSolo:Number, pXpGroup:Number)
   {
      super();
      this._level = pLevel;
      this._group = pGroup;
