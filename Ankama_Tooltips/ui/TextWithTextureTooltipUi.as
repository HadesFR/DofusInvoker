      ...
      public function onTextureReady(target:Object) : void
      {
         ...
         switch(target)
         {
            case this.tx_icon:
               ...
               this.backgroundCtr.width = this.backgroundCtr.width + (this.tx_icon.width + this.tx_icon.anchorX * 2 - 1);
               this.backgroundCtr.height = this.backgroundCtr.height + (this.tx_icon.height + this.tx_icon.anchorY * 2 - 1);
