package Ankama_Tooltips.ui
{
   ...
   public class BreachMonstersGroupTooltipUi
   {
      ...
      private function getBreachMonstersGroupData(monsters:Vector.<MonsterInGroupLightInformations>, pPlayerData:*, pGroupMembersData:Array) : MonstersGroupData#482
      {
         ...
         groupData = new MonstersGroupData#482(totalLevel,grp,FormulaHandler.getInstance().xpSolo,FormulaHandler.getInstance().xpGroup);
         return groupData;
      }
...
class MonstersGroupData#482
{
   ...
   function MonstersGroupData#482(pLevel:int, pGroup:Array, pXpSolo:Number, pXpGroup:Number)
   {
      super();
      this._level = pLevel;
      this._group = pGroup;
