package Ankama_Tooltips.ui
{
   ...
   public class InterfaceTutoTooltipUi
   {
      ...
      private function setTextBlock(param:Object) : void
      {
         ...
         this.backgroundCtr.height = this.backgroundCtr.height + (this.lbl_info.height + this.lbl_info.anchorY * 2);
      }
      ...
      private function setButtonBlock(param:Object) : void
      {
         ...
         this.backgroundCtr.height = this.backgroundCtr.height + (this.ctr_button.height + bgButtonMargin);
      }
      ...
      public function onTextureReady(target:Object) : void
      {
         switch(target)
         {
            case this.tx_illu:
               ...
               this.backgroundCtr.height = 0;
               this.backgroundCtr.height = this.backgroundCtr.height + (this.tx_illu.height + this.tx_illu.anchorY * 2);
               this.setTextBlock(this._param);
