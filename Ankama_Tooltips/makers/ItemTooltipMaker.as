package Ankama_Tooltips.makers
{
   ...
   public class ItemTooltipMaker implements ITooltipMaker
   {
      ...
      public function createTooltip(data:*, param:Object) : Object
      {
         ...
         var _param:paramClass = new paramClass#5750();
         ...
         var tooltip:Object = Api.tooltip.createTooltip(baseChunkFile,chunkType + "/base/container.txt",chunkType + "/base/separator.txt");
      ...
      private function createRandomDropGroupInfo(randomDropGroup:RandomDropGroup) : Array
      {
         ...
         for each(randomItem in randomDropGroup.randomDropItems)
         {
            randomDropItemInfo = {
               ...
               "proba":randomItem.probability / randomDropGroup.groupWeight * 100,
               "rarity":"",
