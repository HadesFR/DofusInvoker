package Ankama_Tooltips.blocks
{
   ...
   public class EffectsTooltipBlock
   {
      ...
      public function onAllChunkLoaded() : void
      {
         ...
         {
            sortedCategory.push(new _EffectPart#551(!!this._isCriticalEffects?Api.ui.getText("ui.common.criticalDamages"):Api.ui.getText("ui.stats.damagesBonus"),DAMAGE,category[0]));
         }
         if(category[1])
         {
            sortedCategory.push(new _EffectPart#551(Api.ui.processText(!!this._isCriticalEffects?Api.ui.getText("ui.common.criticalEffects"):Api.ui.getText("ui.common.effects"),"",category[1].length == 1,category[1].length == 0),SPELL_BOOST,category[1]));
         }
         if(this._setInfo)
         {
      ...
      private function processEffect(effectsPart:_EffectPart#551, ei:Object, chunk:String, chunkArgs:Object = null, showSubEffect:Boolean = true) : String
      {
...
class _EffectPart#551
{
   ...
   function _EffectPart#551(title:String, type:uint, effects:Array)
   {
      super();
      this.title = title;
      this.type = type;
