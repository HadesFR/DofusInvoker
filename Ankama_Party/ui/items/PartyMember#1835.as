package Ankama_Party.ui.items
{
   ...
   public class PartyMember#1835
   {
      ...
      public function PartyMember#1835()
      {
         super();
      }
            ...
            case this.ctr_main:
               ...
               else
               {
                  ...
                  if(!Party.CURRENT_PARTY_TYPE_DISPLAYED_IS_ARENA)
                  {
                     ...
                     {
                        info = info + this.uiApi.getText("ui.party.rollOverPlayerInformationsWithPrestige",this._data.name,this._data.level - ProtocolConstantsEnum.MAX_LEVEL,this._data.prospecting,this._data.lifePoints,this._data.maxLifePoints,this._data.initiative,ProtocolConstantsEnum.MAX_LEVEL);
                     }
                     else
                     {
                  ...
                  {
                     info = info + this.uiApi.getText("ui.party.rollOverArenaPlayerInformationsWithPrestige",this._data.name,this._data.level - ProtocolConstantsEnum.MAX_LEVEL,this._data.rank == 0?"-":this._data.rank,this._data.lifePoints,this._data.maxLifePoints,this._data.initiative);
                  }
                  else
                  {
                     info = info + this.uiApi.getText("ui.party.rollOverArenaPlayerInformations",this._data.name,this._data.level == 0?"--":this._data.level,this._data.rank == 0?"-":this._data.rank,this._data.lifePoints,this._data.maxLifePoints,this._data.initiative);
                  }
               }
               if(info)
               {
