package Ankama_Grimoire.ui.temporis
{
   ...
   public class TemporisSpellSetDeletionPopUp
   {
      ...
      public function TemporisSpellSetDeletionPopUp()
      {
         super();
      }
      ...
      public function main(params:Array) : void
      {
         ...
         var parentUi:UiRootContainer = this.uiApi.getUi(UIEnum.TEMPORIS_SPELL_SET_POP_UP);
         var childUi:UiRootContainer = this.uiApi.getUi(UIEnum.TEMPORIS_SPELL_SET_DELETION_POP_UP);
