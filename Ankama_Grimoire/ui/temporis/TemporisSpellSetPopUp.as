package Ankama_Grimoire.ui.temporis
{
   ...
   public class TemporisSpellSetPopUp
   {
      ...
      public function TemporisSpellSetPopUp()
      {
         super();
      }
      ...
      public function main(params:Array) : void
      {
         ...
         var parentUi:UiRootContainer = this.uiApi.getUi(UIEnum.TEMPORIS_SPELLS_UI);
         var childUi:UiRootContainer = this.uiApi.getUi(UIEnum.TEMPORIS_SPELL_SET_POP_UP);
      ...
      private function deleteSpellSet(spellSetDescr:Object, isForce:Boolean = false) : void
      {
         if(!isForce)
         {
            if(!this.uiApi.getUi(UIEnum.TEMPORIS_SPELL_SET_DELETION_POP_UP))
            {
               this.uiApi.loadUi(UIEnum.TEMPORIS_SPELL_SET_DELETION_POP_UP,UIEnum.TEMPORIS_SPELL_SET_DELETION_POP_UP,[spellSetDescr,function():void
               {
      ...
      private function closeMe() : void
      {
         if(this.uiApi !== null)
         {
            if(this.uiApi.getUi(UIEnum.TEMPORIS_SPELL_SET_DELETION_POP_UP) !== null)
            {
               this.uiApi.unloadUi(UIEnum.TEMPORIS_SPELL_SET_DELETION_POP_UP);
            }
      ...
      public function onSelectItem(target:Object, selectMethod:uint, isNewSelection:Boolean) : void
      {
         ...
         {
            this.updateSpellSetIcon(target.selectedItem.id);
         }
      }
