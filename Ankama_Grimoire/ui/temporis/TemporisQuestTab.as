package Ankama_Grimoire.ui.temporis
{
   ...
   public class TemporisQuestTab
   {
      ...
      public function TemporisQuestTab()
      {
      ...
      public function main(paramsObject:Object = null) : void
      {
         ...
         this.systemApi.dispatchHook(HookList.NewAreNewTemporisRewardsAvailable,false);
      }
      ...
      public function onRollOver(target:Object) : void
      {
         ...
         var tooltipPosition:Object = null;
         this.uiApi.hideTooltip(TOOLTIP_UI_NAME);
         this.uiApi.hideTooltip(STANDARD_TOOLTIP_UI_NAME);
         ...
         else if(target === this.btn_locateScrollMagicWorkshop)
         {
...
class Top extends GridData#6065
{
...
class Reward extends GridData#6065
{
