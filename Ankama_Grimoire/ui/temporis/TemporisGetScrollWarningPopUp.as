package Ankama_Grimoire.ui.temporis
{
   ...
   public class TemporisGetScrollWarningPopUp
   {
      ...
      public function TemporisGetScrollWarningPopUp()
      {
         super();
      }
      ...
      public function main(params:Array) : void
      {
         ...
         this.uiApi.getUi(UIEnum.TEMPORIS_GET_SCROLL_WARNING_POP_UP).strata = this.uiApi.getUi(UIEnum.TEMPORIS_SPELLS_UI).strata - 1;
