package Ankama_Grimoire.ui
{
   ...
   public class JobTab
   {
      ...
      public function main(oParam:Object = null) : void
      {
         ...
         this._meats = new Array();
         var meatItemIds:Object = this.dataApi.queryEquals(Item,"typeId",DataEnum.ITEM_TYPE_MEAT);
      ...
      public function updateJobLine(data:*, componentsRef:*, selected:Boolean) : void
      {
         ...
         if(data)
         {
            ...
            {
               componentsRef.lbl_name.text = componentsRef.lbl_name.text + (" (" + data.id + ")");
            }
            ...
            if(selected)
            {
               componentsRef.btn_job.selected = true;
            }
            else
            {
      ...
      private function switchJob() : void
      {
         ...
         var skills:Object = this.jobsApi.getJobSkills(this._currentJob.id);
         var collectSkills:Array = new Array();
         ...
         if(this._currentJob.id == DataEnum.JOB_ID_HUNTER)
         {
            ...
            meatsHuntableAtCurrentLevel = new Array();
