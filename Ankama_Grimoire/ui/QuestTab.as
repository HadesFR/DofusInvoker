package Ankama_Grimoire.ui
{
   ...
   public class QuestTab
   {
         ...
         if(data)
         {
            ...
            else
            {
               ...
               if(quest != null)
               {
                  ...
                  lvlQuest = quest.levelMin == quest.levelMax || quest.levelMin > quest.levelMax?quest.levelMin:quest.levelMin + "-" + quest.levelMax;
      ...
      private function getQuestName(quest:Object) : String
      {
      ...
      public function updateObjectivesItem(data:*, componentsRef:*, selected:Boolean) : void
      {
         ...
         if(data)
         {
            ...
            if(this.sysApi.getPlayerManager().hasRights)
            {
               objectiveText = objectiveText + (" (" + data.id + ")");
            }
            ...
            else
            {
               ...
               if(objective.coords || objective.mapId)
               {
                  ...
                  flagList = this.modCartography.getFlags(!!mapPos?mapPos.subArea.worldmap.id:this.mapApi.getCurrentWorldMap().id);
      ...
      private function updateQuestGrid() : void
      {
         ...
         var categoryResult:Object = null;
      ...
      private function updateStep(completedQuest:Boolean = false) : void
      {
         ...
         quest = this.dataApi.getQuest(this._selectedQuest);
         this.btn_follow.visible = !completedQuest && quest.followable;
      }
      ...
      public function onRollOver(target:Object) : void
      {
         ...
         {
            this.uiApi.showTooltip(this.uiApi.textTooltipInfo(target.uri == this._pinSelectedUri?this.uiApi.getText("ui.quest.unfollow"):this.uiApi.getText("ui.quest.follow")),target,false,"followQuest",7,1,3,null,null,null,"TextInfo");
         }
         ...
         {
            this.uiApi.showTooltip(this.uiApi.textTooltipInfo(target.uri == this._dungeonIconUri?this.uiApi.getText("ui.quest.dungeonQuest"):this.uiApi.getText("ui.quest.partyQuest")),target,false,"standard",7,1,3,null,null,null,"TextInfo");
         }
      }
      ...
      public function onQuestInfosUpdated(questId:uint, infosAvailable:Boolean) : void
      {
         ...
         if(questId == this._selectedQuest)
         {
            ...
            this.updateStep(this.questApi.getCompletedQuests().indexOf(questId) != -1);
