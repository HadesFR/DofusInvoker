package Ankama_Grimoire.ui
{
   ...
   public class AlignmentTab
   {
      ...
      public function main(oParam:Object = null) : void
      {
         ...
         if(shortcut != "")
         {
            this.lbl_title.text = this.lbl_title.text + (" (" + shortcut + ")");
         }
         ...
         this._server = this.sysApi.getCurrentServer();
         if(this._server.gameTypeId == GameServerTypeEnum.SERVER_TYPE_TEMPORIS && this.dataApi.getCurrentSeason().seasonNumber == 3)
         {
