package Ankama_Mount.ui
{
   ...
   public class MountPaddock
   {
      ...
      private var _infoRequestTimer:Timer;
      ...
      public function main(params:Object) : void
      {
         ...
         if(shortcut)
         {
            this.btn_lbl_btn_equip.text = this.btn_lbl_btn_equip.text + (" (" + shortcut + ")");
         }
         shortcut = this.bindsApi.getShortcutBindStr(SHORTCUT_EXCHANGE);
         if(shortcut)
         {
            this.btn_lbl_btn_exchange.text = this.btn_lbl_btn_exchange.text + (" (" + shortcut + ")");
         }
         shortcut = this.bindsApi.getShortcutBindStr(SHORTCUT_PARK);
         if(shortcut)
         {
            this.btn_lbl_btn_park.text = this.btn_lbl_btn_park.text + (" (" + shortcut + ")");
         }
         shortcut = this.bindsApi.getShortcutBindStr(SHORTCUT_STOCK);
         if(shortcut)
         {
            this.btn_lbl_btn_stock.text = this.btn_lbl_btn_stock.text + (" (" + shortcut + ")");
         }
         ...
         this._infoRequestTimer = new Timer(100,1);
         ...
         if(this._lastSource != source)
         {
            ...
            else
            {
               ...
               if(source == 0)
               {
                  ...
                  this.btn_park.disabled = false || this.playerApi.hasDebt() && !this._isPublic;
