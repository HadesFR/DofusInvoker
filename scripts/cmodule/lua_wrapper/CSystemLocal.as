package cmodule.lua_wrapper
{
   ...
   public class CSystemLocal implements CSystem
   {
      ...
      public function CSystemLocal(param1:Boolean = false)
      {
         ...
         CSystemLocal.width = !!CSystemLocal?Number(CSystemLocal.stage.stageWidth):Number(800);
         CSystemLocal.height = !!CSystemLocal?Number(CSystemLocal.stage.stageHeight):Number(600);
