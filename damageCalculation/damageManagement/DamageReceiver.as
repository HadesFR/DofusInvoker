package damageCalculation.damageManagement
{
   ...
   public class DamageReceiver
   {
      ...
      {
         var _loc10_:* = null as DamageRange;
         var _loc11_:* = null as RunningEffect;
         var _loc12_:* = null as Array;
         var _loc14_:* = null as EffectOutput;
         var _loc7_:HaxeSpellEffect = param2.getSpellEffect();
         var _loc8_:Array = [];
         var _loc9_:* = DamageReceiver.executeDodge(param1,param2,param4,param5,param6);
         if(_loc9_.done)
         {
            return _loc9_.damages;
         }
         if(!param3.isCollision)
         {
            ...
            {
               _loc10_ = DamageRange.ZERO;
               param4.lastRawDamageTaken = _loc10_;
               param3 = _loc10_;
            }
            ...
            {
               _loc10_ = DamageReceiver.reflectDamages(param1,param2,param3,param4);
               if(_loc10_ != null)
               {
                  _loc11_ = param2.copy();
                  _loc11_.isReflect = true;
                  _loc8_ = _loc8_.concat(DamageReceiver.receiveDamageOrHeal(param1,_loc11_,_loc10_,param2.getCaster(),param5));
               }
            }
            param3.multiply(1 - int(param4.getElementMainResist(param3.elemId)) / 100);
            param3.minimizeBy(0);
            _loc12_ = DamageReceiver.getSplitDamages(param1,param2,param3,param4,param6);
            if(_loc12_ != null)
            {
               return _loc8_.concat(_loc12_);
            }
         }
         var _loc13_:EffectOutput = DamageReceiver.applyDamages(param2,param4,param3,param5,param6);
         if(!!ActionIdHelper.isLifeSteal(param2.getSpellEffect().actionId) && param2.getCaster() != param4)
         {
            _loc14_ = DamageReceiver.getLifeStealEffect(_loc13_.computeLifeDamage(),param2.getCaster());
            if(_loc14_ != null)
            {
               _loc8_.push(_loc14_);
            }
         ...
         if(!param3.isCollision)
         {
            _loc13_.fighterId = Number(DamageReceiver.changeTargetIfSacrifice(param1,param2,_loc13_,param4,param5));
         }
         _loc8_.push(_loc13_);
         return _loc8_;
      }
      ...
      public static function getPermanentDamage(param1:DamageRange, param2:HaxeFighter) : DamageRange
      {
         ...
         var _loc3_:Number = int(Math.floor(Number(Math.max(0,Number(Math.min(int(param2.getCharacteristicValue("permanentDamagePercent")),50)))))) / 100;
         var _loc4_:DamageRange = new DamageRange(int(Math.floor(param1.min * _loc3_)),int(Math.floor(param1.max * _loc3_)));
         var _loc5_:* = int(param2.getCharacteristicValue("lifePoints")) - 1;
      ...
      public static function getDamageBasedOnTargetLife(param1:HaxeSpellEffect, param2:HaxeFighter, param3:DamageRange) : DamageRange
      {
         ...
         {
            param3.multiply(int(param2.getCharacteristicValue("maxLifePoints")) / 100);
         }
         ...
         {
            param3.multiply(int(param2.getCharacteristicValue("permanentDamagePercent")) / 100);
         }
         return param3;
      }
      ...
      public static function applyDamages(param1:RunningEffect, param2:HaxeFighter, param3:DamageRange, param4:Boolean, param5:Boolean) : EffectOutput
      {
      ...
      public static function applyDealtMultiplier(param1:RunningEffect, param2:DamageRange, param3:HaxeFighter, param4:Boolean = false) : DamageRange
      {
         ...
         if(ActionIdHelper.isBoostable(param1.getSpellEffect().actionId))
         {
            ...
            param2.increaseByPercent(int(_loc5_.getCharacteristicValue("dealtDamagesMultiplicator")));
         }
         param2.multiply(int(param3.getDamageMultiplicator(param1,param4,param2.isCollision)) / 100);
         return param2;
      }
      
      public static function reflectDamages(param1:FightContext, param2:RunningEffect, param3:DamageRange, param4:HaxeFighter) : DamageRange
      {
         var _loc9_:* = null as DamageRange;
         var _loc10_:int = 0;
         var _loc5_:HaxeSpellEffect = param2.getSpellEffect();
         var _loc6_:int = param4.getCharacteristicValue("reflect");
         ...
         if(!(_loc8_.min == 0 && _loc8_.max == 0))
         {
            ...
            {
               _loc10_ = param2.getCaster().getCharacteristicValue("dealtDamagesMultiplicator");
               _loc9_.multiply(Number(1 + _loc10_ / 100));
            }
      ...
      public static function getFlatResistance(param1:RunningEffect, param2:HaxeFighter, param3:int) : int
      {
         ...
         {
            _loc6_ = _loc6_ + int(param2.getCharacteristicValue("criticalDamageReduction"));
         }
         _loc6_ = _loc6_ + int(param2.getElementMainReduction(param3));
         return _loc6_;
      }
      
      public static function getSplitDamages(param1:FightContext, param2:RunningEffect, param3:DamageRange, param4:HaxeFighter, param5:Boolean = false) : Array
      {
               ...
               _loc11_ = function(param1:Array):Function
               {
                  ...
                  return function(param1:HaxeFighter):Array
                  {
                     ...
                     if(param1 != target)
                     {
                        ...
                        if(_loc3_.done)
                        {
                           return _loc3_.damages;
                        }
                     }
                     var _loc4_:DamageRange = splitDamage1[0].copy();
                     return [DamageReceiver.applyDamages(runningEffect,param1,_loc4_,_loc2_,isPreview)];
                  };
               }(splitDamage);
      ...
      public static function executeLifePointsWin(param1:DamageRange, param2:HaxeFighter) : EffectOutput
      {
         ...
         {
            _loc3_ = new Interval(int(param2.getCharacteristicValue("maxLifePoints")),int(param2.getCharacteristicValue("maxLifePoints"))).subInterval(param2.getPendingLifePoints());
      ...
      public static function executeDodge(param1:FightContext, param2:RunningEffect, param3:HaxeFighter, param4:Boolean = false, param5:Boolean = false) : Object
      {
         ...
         if(!param5 && param4 && param2.getCaster() != param3)
         {
            ...
            if(_loc6_ != -1)
            {
               return {
                  "done":true,
                  "damages":PushUtils.push(param1,param2,param3,_loc6_,true,true,param5)
               };
            }
         }
         return {
