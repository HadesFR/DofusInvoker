package damageCalculation.damageManagement
{
   ...
   public class PushUtils
   {
      ...
      public static function push(param1:FightContext, param2:RunningEffect, param3:HaxeFighter, param4:int, param5:Boolean, param6:Boolean, param7:Boolean) : Array
      {
         ...
         var _loc14_:int = !!_loc9_?_loc13_:param1.targetedCell;
         var _loc15_:int = PushUtils.getPushDirection(_loc12_,_loc14_,_loc13_,!param1.inMovement);
         return PushUtils.drag(param1,param2,param3,param4,_loc15_,param5,param6,param7,false);
      }
