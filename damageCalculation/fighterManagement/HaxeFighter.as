package damageCalculation.fighterManagement
{
   ...
   public class HaxeFighter
   {
      ...
      public function HaxeFighter(param1:Number, param2:int, param3:int, param4:PlayerTypeEnum, param5:uint, param6:Boolean, param7:Array, param8:IFighterData)
      {
         var _loc10_:* = null as HaxeBuff;
         _save = null;
         ...
         teamId = param5;
         var _loc9_:int = 0;
         while(_loc9_ < int(param7.length))
         {
            _loc10_ = param7[_loc9_];
            _loc9_++;
            _buffs.add(_loc10_);
         }
      }
      ...
      public function storeSpellEffectStatBoost(param1:HaxeSpell, param2:HaxeSpellEffect) : void
      {
         ...
         _loc3_.actionId = int(ActionIdHelper.statBoostToBuffActionId(param2.actionId));
         var _loc4_:HaxeBuff = new HaxeBuff(id,param1,_loc3_);
         storePendingBuff(_loc4_);
      }
      ...
      public function isAlive() : Boolean
      {
         ...
         if(!_loc1_)
         {
            return int(getCharacteristicValue("lifePoints")) > 0;
         }
         return false;
      }
      ...
      public function getSpellDamageModification(param1:int) : int
      {
         ...
         while(_loc3_ != null)
         {
            ...
            {
               _loc2_ = _loc2_ + _loc6_.effect.param3;
            }
         }
         return _loc2_;
      }
      ...
      public function getPendingShield() : Interval
      {
         ...
         var _loc1_:Interval = new Interval(int(getCharacteristicValue("shieldPoints")),int(getCharacteristicValue("shieldPoints")));
      ...
      public function getPendingMissingLifePoints() : Interval
      {
         ...
         var _loc1_:Interval = new Interval(int(getCharacteristicValue("maxLifePoints")) - int(getCharacteristicValue("lifePoints")),int(getCharacteristicValue("maxLifePoints")) - int(getCharacteristicValue("lifePoints")));
         var _loc2_:ListNode = pendingEffects.h;
         while(_loc2_ != null)
         {
            _loc3_ = _loc2_.item;
         ...
         _loc1_.minimizeBy(0);
         _loc1_.maximizeBy(int(getCharacteristicValue("maxLifePoints")));
         return _loc1_;
      }
      ...
      public function getPendingLifePoints() : Interval
      {
         ...
         var _loc4_:* = null as EffectOutput;
         var _loc5_:* = null as DamageRange;
         var _loc1_:Interval = new Interval(int(getCharacteristicValue("lifePoints")),int(getCharacteristicValue("lifePoints")));
         var _loc2_:ListNode = pendingEffects.h;
         while(_loc2_ != null)
         {
            _loc3_ = _loc2_.item;
      ...
      {
         return int(getCharacteristicValue("maxLifePoints"));
      }
      
      public function getLifePoint() : int
      {
         return int(getCharacteristicValue("lifePoints"));
      }
      ...
      public function getElementMainStat(param1:int) : int
      {
         ...
         {
            case 0:
               return int(getCharacteristicValue("strength"));
            case 1:
               return int(getCharacteristicValue("strength"));
            case 2:
               return int(getCharacteristicValue("intelligence"));
            case 3:
               return int(getCharacteristicValue("chance"));
            case 4:
               return int(getCharacteristicValue("agility"));
            default:
               return 0;
            case 6:
      ...
      public function getElementMainResist(param1:int) : int
      {
         ...
         {
            case 0:
               _loc3_ = getCharacteristicValue("neutralElementResistPercent");
               break;
            case 1:
               _loc3_ = getCharacteristicValue("earthElementResistPercent");
               break;
            case 2:
               _loc3_ = getCharacteristicValue("fireElementResistPercent");
               break;
            case 3:
               _loc3_ = getCharacteristicValue("waterElementResistPercent");
               break;
            case 4:
               _loc3_ = getCharacteristicValue("airElementResistPercent");
         }
         if(_loc3_ > _loc2_)
         {
            return _loc2_;
      ...
      public function getElementMainReduction(param1:int) : int
      {
         ...
         {
            case 0:
               return int(getCharacteristicValue("neutralElementReduction"));
            case 1:
               return int(getCharacteristicValue("earthElementReduction"));
            case 2:
               return int(getCharacteristicValue("fireElementReduction"));
            case 3:
               return int(getCharacteristicValue("waterElementReduction"));
            case 4:
               return int(getCharacteristicValue("airElementReduction"));
         }
      }
      ...
      public function getElementFlatDamageBonus(param1:int) : int
      {
         ...
         {
            case 0:
               return int(getCharacteristicValue("neutralDamageBonus"));
            case 1:
               return int(getCharacteristicValue("earthDamageBonus"));
            case 2:
               return int(getCharacteristicValue("fireDamageBonus"));
            case 3:
               return int(getCharacteristicValue("waterDamageBonus"));
            case 4:
               return int(getCharacteristicValue("airDamageBonus"));
            default:
               return 0;
            case 6:
      ...
      {
         var _loc2_:String = !!param1?"meleeDamageReceivedPercent":"rangedDamageReceivedPercent";
         var _loc3_:Number = int(getCharacteristicValue(_loc2_));
         return int(Number(Math.max(0,_loc3_)));
      }
      
      public function getCurrentReceivedDamageMultiplierCategory(param1:Boolean) : int
      {
         var _loc2_:String = !!param1?"weaponDamageReceivedPercent":"spellDamageReceivedPercent";
         var _loc3_:Number = int(getCharacteristicValue(_loc2_));
         return int(Number(Math.max(0,_loc3_)));
      }
      ...
      {
         var _loc2_:String = !!param1?"meleeDamageDonePercent":"rangedDamageDonePercent";
         var _loc3_:Number = 100 + int(getCharacteristicValue(_loc2_));
         return int(Number(Math.max(0,_loc3_)));
      }
      
      public function getCurrentDealtDamageMultiplierCategory(param1:Boolean) : int
      {
         var _loc2_:String = !!param1?"weaponDamageDonePercent":"spellDamageDonePercent";
         var _loc3_:Number = 100 + int(getCharacteristicValue(_loc2_));
         return int(Number(Math.max(0,_loc3_)));
      }
      
      public function getCharacteristicValue(param1:String) : int
      {
         var _loc2_:* = int(data.getBaseCharacteristicValue(param1));
         var _loc3_:Boolean = ActionIdHelper.isLinearBuffActionIds(param1);
         var _loc4_:int = getBuffStatBoost(param1);
         var _loc5_:int = getBuffStatBoostPercent(param1);
         if(_loc3_)
         {
         ...
         {
            _loc2_ = int(Math.floor(_loc2_ * (1 + _loc4_ * 0.01)));
         }
         if(_loc2_ != 0)
         {
            _loc2_ = int(Math.floor(_loc2_ * (1 + _loc5_ * 0.01)));
         }
         return _loc2_;
      }
      ...
      public function getBuffStatBoostPercent(param1:String) : int
      {
         var _loc6_:* = null as LinkedListNode;
         var _loc7_:* = null as LinkedListNode;
         var _loc8_:* = null as HaxeBuff;
         var _loc2_:int = ActionIdHelper.StatToBuffPercentActionIds(param1);
         var _loc3_:int = ActionIdHelper.StatToDebuffPercentActionIds(param1);
         if(_loc2_ == -1 && _loc3_ == -1)
         {
            return 0;
         }
         var _loc4_:* = 100;
         var _loc5_:LinkedListNode = _buffs.head;
         while(_loc5_ != null)
         {
            _loc6_ = _loc5_;
            _loc5_ = _loc5_.next;
            _loc7_ = _loc6_;
            _loc8_ = _loc7_.item;
            if(SpellManager.isInstantaneousSpellEffect(_loc8_.effect))
            {
               if(_loc8_.effect.actionId == _loc2_)
               {
                  _loc4_ = int(Math.floor(_loc4_ * (1 + int(_loc8_.effect.getMinRoll()) * 0.01)));
               }
               else if(_loc8_.effect.actionId == _loc3_)
               {
                  _loc4_ = int(Math.floor(_loc4_ * (1 - int(_loc8_.effect.getMinRoll()) * 0.01)));
               }
            }
      ...
      public function getBuffStatBoost(param1:String) : int
      {
         var _loc6_:* = null as LinkedListNode;
         var _loc7_:* = null as LinkedListNode;
         var _loc8_:* = null as LinkedListNode;
         var _loc9_:* = null as HaxeBuff;
         var _loc2_:int = ActionIdHelper.StatToBuffActionIds(param1);
         var _loc3_:int = ActionIdHelper.StatToDebuffActionIds(param1);
         var _loc4_:Boolean = ActionIdHelper.isLinearBuffActionIds(param1);
         var _loc5_:* = 0;
         if(_loc4_)
         {
            _loc6_ = _buffs.head;
            while(_loc6_ != null)
            {
               ...
               _loc8_ = _loc7_;
               _loc9_ = _loc8_.item;
               if(SpellManager.isInstantaneousSpellEffect(_loc9_.effect))
               {
                  if(_loc9_.effect.actionId == _loc2_)
                  {
                     _loc5_ = _loc5_ + int(_loc9_.effect.getMinRoll());
                  }
                  else if(_loc9_.effect.actionId == _loc3_)
                  {
                     _loc5_ = _loc5_ - int(_loc9_.effect.getMinRoll());
                  }
               }
         ...
         else
         {
            ...
            while(_loc6_ != null)
            {
               ...
               if(SpellManager.isInstantaneousSpellEffect(_loc9_.effect))
               {
                  if(_loc9_.effect.actionId == _loc2_)
                  {
                     _loc5_ = int(Math.floor(_loc5_ * (1 + int(_loc9_.effect.getMinRoll()) * 0.01)));
                  }
                  else if(_loc9_.effect.actionId == _loc3_)
                  {
                     _loc5_ = int(Math.floor(_loc5_ * (1 - int(_loc9_.effect.getMinRoll()) * 0.01)));
      ...
      public function canTeleport(param1:int = -1, param2:Boolean = true) : Boolean
      {
         if(!hasStateEffect(3) && !(!!hasStateEffect(18) && isSwitchTeleport(param1)) && !hasState(3))
         {
            if(param2)
            {
      ...
      public function canSwitchPosition(param1:int = -1, param2:Boolean = true) : Boolean
      {
         if(canTeleport(param1,param2))
         {
            return !hasState(8);
         }
         return false;
