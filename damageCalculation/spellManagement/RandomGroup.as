   ...
   public class RandomGroup
   {
      ...
      public function RandomGroup(param1:Array)
      {
         ...
         while(_loc2_ < int(param1.length))
         {
            ...
            _loc2_++;
            weight = weight + _loc3_.randomWeight;
         }
      }
      
      public static function totalWeight(param1:IMap) : int
      {
         ...
         while(_loc4_ < int(param1.length))
         {
            ...
            if(_loc5_.randomWeight > 0)
            {
               ...
               if(_loc6_ in _loc2_.h)
               {
                  ...
                  _loc7_.weight = _loc7_.weight + _loc5_.randomWeight;
               }
               else
               {
      ...
      public static function selectRandomGroup(param1:IMap) : Array
      {
         ...
         var _loc2_:* = int(Math.floor(int(RandomGroup.totalWeight(param1)) * Math.random()));
         var _loc3_:RandomGroup = null;
         var _loc4_:* = new IntMapValuesIterator(param1.h);
         while(_loc4_.hasNext())
         {
            _loc5_ = _loc4_.next();
            _loc2_ = _loc2_ - _loc5_.weight;
            if(_loc2_ <= 0)
            {
               break;
            }
      ...
      {
         effects.push(param1);
         weight = weight + param1.randomWeight;
      }
   }
}
