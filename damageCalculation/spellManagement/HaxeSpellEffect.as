package damageCalculation.spellManagement
{
   ...
   public class HaxeSpellEffect
   {
      ...
      public function HaxeSpellEffect(param1:uint, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:int, param9:Boolean, param10:String, param11:String, param12:String, param13:int, param14:int, param15:Boolean, param16:int, param17:int)
      {
         id = param1;
         level = param2;
         order = param3;
