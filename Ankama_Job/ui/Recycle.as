   ...
   public class Recycle
   {
      ...
      private function prepareItem(itemWrapper:Object) : Object
      {
         ...
         for each(nuggetsBySubarea in itemWrapper.nuggetsBySubarea)
         {
            ...
            {
               nuggets = nuggets + this.ZONE_BONUS * nuggetsBySubarea[1];
            }
            else
            {
               nuggets = nuggets + nuggetsBySubarea[1];
            }
         }
         bonus = 0;
      ...
      private function onExchangeObjectAdded(itemWrapper:Object, remote:Object) : void
      {
         ...
         this._estimatedItemsPrice = this._estimatedItemsPrice + this.averagePricesApi.getItemAveragePrice(itemWrapper.objectGID) * itemWrapper.quantity;
         this._charNuggetsQuantity = this._charNuggetsQuantity + dataObject.charNuggetsQty;
         this._allianceNuggetsQuantity = this._allianceNuggetsQuantity + dataObject.allianceNuggetsQty;
      ...
      private function onExchangeObjectListAdded(objectList:Object, remote:Object) : void
      {
         ...
         for each(wrapper in objectList)
         {
            ...
            this._itemsToRecycle.push(dataObject);
            this._estimatedItemsPrice = this._estimatedItemsPrice + this.averagePricesApi.getItemAveragePrice(wrapper.objectGID) * wrapper.quantity;
            this._charNuggetsQuantity = this._charNuggetsQuantity + dataObject.charNuggetsQty;
            this._allianceNuggetsQuantity = this._allianceNuggetsQuantity + dataObject.allianceNuggetsQty;
      ...
      private function onExchangeObjectModified(itemWrapper:Object, remote:Boolean) : void
      {
         ...
         for(i in this._itemsToRecycle)
         {
            if(this._itemsToRecycle[i].item.objectUID == itemWrapper.objectUID)
            {
               ...
               this._estimatedItemsPrice = this._estimatedItemsPrice - itemPrice * this._itemsToRecycle[i].item.quantity;
               this._estimatedItemsPrice = this._estimatedItemsPrice + itemPrice * itemWrapper.quantity;
               this._charNuggetsQuantity = this._charNuggetsQuantity - this._itemsToRecycle[i].charNuggetsQty;
               this._allianceNuggetsQuantity = this._allianceNuggetsQuantity - this._itemsToRecycle[i].allianceNuggetsQty;
      ...
      private function onExchangeObjectRemoved(itemUID:int, remote:Boolean) : void
      {
         ...
         for(i in this._itemsToRecycle)
         {
            ...
            {
               index = i;
               this._estimatedItemsPrice = this._estimatedItemsPrice - this.averagePricesApi.getItemAveragePrice(this._itemsToRecycle[i].item.objectGID) * this._itemsToRecycle[i].item.quantity;
               this._charNuggetsQuantity = this._charNuggetsQuantity - this._itemsToRecycle[i].charNuggetsQty;
               this._allianceNuggetsQuantity = this._allianceNuggetsQuantity - this._itemsToRecycle[i].allianceNuggetsQty;
