   ...
   public class LevelUpUi
   {
      ...
      public function onRollOver(target:Object) : void
      {
         ...
         else if(target.name.indexOf("tx_icon") != -1)
         {
            ...
            else if(target.uri.fileName.indexOf("heart_reward") != -1)
            {
               txt = this.uiApi.getText("ui.levelUp.tooltip.lifePoints");
            }
            else if(target.uri.fileName.indexOf("characteristic_reward") != -1)
            {
               txt = this.uiApi.getText("ui.levelUp.caracPoints");
            }
            else if(target.uri.fileName.indexOf("bag_reward") != -1)
            {
               txt = this.uiApi.getText("ui.common.weight");
            }
            else if(target.uri.fileName.indexOf("star_reward") != -1)
            {
