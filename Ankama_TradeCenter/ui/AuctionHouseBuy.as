package Ankama_TradeCenter.ui
{
   ...
   public class AuctionHouseBuy extends Stock
   {
      ...
      public var modTradeCenter:Object;
      ...
      private var _specificSearchTimer:Timer;
      ...
      override public function main(params:Object = null) : void
      {
         ...
         this._levelTimer = new Timer(700,1);
         ...
         {
            this._specificSearchTimer = new Timer(500,1);
      ...
      private function updateOpenedItemIndex(startIndex:uint, delta:int) : void
      {
         ...
         for each(openedItem in this._openedItemsDetails)
         {
            ...
            {
               openedItem.currentIndex = openedItem.currentIndex + delta;
            }
         }
      }
      ...
      private function getAllRunesFromItemEffects(onlyAvailableRunes:Boolean) : void
      {
         ...
         var itemWrapper:ItemWrapper = null;
         var averagePrice:Number = NaN;
         var tmpIds:Array = this.itemFilterApi.filterRunesFromItemEffects(this.characsIdList);
         var ids:Array = [];
         ...
         if(items && items.length > 0)
         {
            ...
            if(this._openedItemsDetails.length > 0)
            {
               ...
               for each(openedItem in this._openedItemsDetails)
               {
                  ...
                  {
                     delta = delta + openedItem.data.length;
                  }
               }
      ...
      override public function onSelectItem(target:Object, selectMethod:uint, isNewSelection:Boolean) : void
      {
         switch(target)
         {
            ...
            case this.gd_itemList:
               if(selectMethod != GridItemSelectMethodEnum.AUTO && target.selectedItem && !target.selectedItem.isItemDetails && !uiApi.keyIsDown(Keyboard.SHIFT))
               {
                  if(!this.isOpened(target.selectedItem))
                  {
                     ...
                     this._lastItemSelected = target.selectedItem;
                  ...
                  {
                     this.followItem(target.selectedItem.itemWrapper.typeId,target.selectedItem.itemWrapper.objectGID,false);
                     this._lastItemSelected = target.selectedItem;
                     if(this._specificSearchCriteria && this.inp_specificSearch)
                     {
                        this._specificSearchCriteria = null;
      ...
      override public function onItemRollOver(target:Object, item:Object) : void
      {
         super.onItemRollOver(target,item);
      }
      
      override public function onItemRollOut(target:Object, item:Object) : void
      {
      ...
      override public function onKeyUp(target:Object, keyCode:uint) : void
      {
