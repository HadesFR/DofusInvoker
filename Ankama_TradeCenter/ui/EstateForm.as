   ...
   public class EstateForm
   {
      ...
      private function updateInformations() : void
      {
         ...
         if(this._estateType == 0)
         {
            ...
            else if(this._data.ownerName == PlayerManager.getInstance().nickname)
            {
            ...
            else
            {
               ...
               this.btn_mp.disabled = !this._data.ownerCharacterName;
               this.lbl_ownerContent.text = this.lbl_ownerContent.text + (" (" + (!this._data.ownerCharacterName?this.uiApi.getText("ui.server.state.offline"):this._data.ownerCharacterName) + ")");
            }
         }
         else
         {
      ...
      public function onRelease(target:Object) : void
      {
         switch(target)
         {
            ...
            case this.btn_loc:
               ...
               break;
            case this.btn_mp:
               if(this._data.ownerCharacterName)
               {
