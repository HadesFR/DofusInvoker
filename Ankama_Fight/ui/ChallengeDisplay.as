package Ankama_Fight.ui
{
   ...
   public class ChallengeDisplay
   {
      ...
      public function updateChallengeGrid(data:*, components:*, isSelected:Boolean, line:uint) : void
      {
         ...
         switch(this.getGridDataType(data,line))
         {
            case TYPE_GRID_DATA_CHALLENGE:
               challenge = (data as ChallengeDisplay).challenge;
            ...
            case TYPE_GRID_DATA_PANEL:
               panelGridData = data as ChallengeDisplay;
      ...
      private function addGridData(gridData:Vector.<GridData#499>, challengeCategoryData:ChallengeCategoryData) : void
      {
         var challenge:ChallengeWrapper = null;
         var index:uint = 0;
      ...
      private function displayChallenges() : void
      {
         ...
         this._isLastItemAPanel = false;
         var gridData:Vector.<GridData> = new Vector.<ChallengeDisplay>();
         var me:UiRootContainer = this.uiApi.me();
         if(me !== null)
         {
      ...
      {
         var challengeCategoryData:Object = null;
...
class ChallengeGridData extends GridData#499
{
...
class PanelGridData extends GridData#499
{
