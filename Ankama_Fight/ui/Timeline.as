package Ankama_Fight.ui
{
   ...
   import Ankama_Fight.ui.timeline.Fighter#496;
   ...
   public class Timeline
   {
      ...
      private var _selectedFighter:Fighter#496 = null;
      
      private var _currentFighter:Fighter#496 = null;
      ...
      private function createFighter(id:Number, num:uint) : Fighter#496
      {
         var f:Fighter = new Fighter#496(id,this.uiApi.me(),num);
      ...
      private function selectFighter(fighter:Fighter#496) : void
      {
      ...
      private function setTurnOf(fighter:Fighter#496, waitTime:int, remainingTime:uint) : void
      {
      ...
      private function unsetTurnOf(fighter:Fighter#496) : void
      {
      ...
      private function getFighterByFrame(frame:Object) : Fighter#496
      {
         var fighter:Fighter = null;
      ...
      public function getFighterById(id:Number) : Fighter#496
      {
         var fighter:Fighter = null;
         for each(fighter in this._fighters)
         {
      ...
      private function refreshLifeThreshold(fighter:Fighter#496) : void
      {
