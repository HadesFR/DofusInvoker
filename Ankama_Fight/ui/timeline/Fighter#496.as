package Ankama_Fight.ui.timeline
{
   ...
   public class Fighter#496
   {
      ...
      public function Fighter#496(id:Number, timelineUi:Object, num:uint)
      {
         super();
         this._id = id;
      ...
      public function setPdv(lifePoints:int) : void
      {
         ...
         var currentHeartRatio:Number = lifePoints / infos.maxLifePoints;
         if(lifePoints === 0)
         {
            result = 0;
         }
      ...
      public function refreshPdvThreshold(threshold:uint) : void
      {
         if(this._alive)
         {
            this.setPdvThreshold(threshold);
         }
      }
      ...
      public function setPdvThreshold(lifePointsThreshold:int) : void
      {
         ...
         var maxHealth:Number = infos.maxLifePoints;
      ...
      public function setShield(currentShield:int) : void
      {
         ...
         else
         {
            ...
            currentHeartPos = this._shieldPoints / infos.maxLifePoints;
