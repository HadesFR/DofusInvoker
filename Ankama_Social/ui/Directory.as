package Ankama_Social.ui
{
   ...
   public class Directory
   {
      ...
      private function onWhoisInfo(accountId:uint, accountNickname:String, areaId:uint, playerId:Number, playerName:String, position:uint, socialGroups:Object) : void
      {
