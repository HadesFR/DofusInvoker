package Ankama_Social.ui
{
   ...
   public class CollectedTaxCollector
   {
      ...
      public function main(pParams:Object) : void
      {
         ...
         {
            ponyLook = "{714|";
            ponyLook = ponyLook + (this.dataApi.getEmblemSymbol(myGuild.upEmblem.idEmblem).skinId + "|");
            ponyLook = ponyLook + ("7=" + myGuild.backEmblem.color + ",8=" + myGuild.upEmblem.color + "|110}");
         ...
         for each(objItemQty in this._collectedTaxCollector.collectedItems)
         {
            ...
            items.push(itemObj);
            totalEstimatedKamas = totalEstimatedKamas + itemObj.averagePrice;
         }
