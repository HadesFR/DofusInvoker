         ...
         switch(target)
         {
            ...
            case this.lbl_motd:
               ...
               if(this._guild.motdWriterName != "")
               {
                  ...
                  tooltipText = tooltipText + this.uiApi.getText("ui.motd.lastModification",this.timeApi.getDate(date,true) + " " + this.timeApi.getClock(date,true,true),this._guild.motdWriterName);
               }
               break;
