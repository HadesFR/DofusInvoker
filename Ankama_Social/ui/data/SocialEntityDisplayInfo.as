package Ankama_Social.ui.data
{
   ...
   public class SocialEntityDisplayInfo
   {
      ...
      private function createInfoFromTaxCollector(data:TaxCollectorWrapper) : void
      {
         ...
         if(data.additionalInformation.collectorCallerName == Api.player.getPlayedCharacterInfo().name)
         {
            this.belongsToMe = true;
         }
      ...
      private function descriptionUpdate() : void
      {
         ...
         this.description = this.description + this._descriptionOfOwner;
         this.description = this.description + this._descriptionOfStartDate;
      }
      
      public function get symbolUri() : Object
      {
         return this._symbolUri;
      }
      
      public function set symbolUri(uri:Object) : void
      {
         this._symbolUri = uri;
      }
