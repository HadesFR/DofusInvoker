   ...
   public class HousesList
   {
      ...
      private function displayHouses() : void
      {
         ...
         if(this._houses.length == 1)
         {
            ...
            this.ctr_main.height = this.ctr_main.height - (this.gd_houses.slotHeight + this.ctr_bottom.height);
            this.ctr_window.height = this.ctr_window.height - (this.gd_houses.slotHeight + this.ctr_bottom.height);
            this.ctr_block.height = this.ctr_block.height - (this.gd_houses.slotHeight + this.ctr_bottom.height);
            this.tx_bgLight.height = this.tx_bgLight.height - this.gd_houses.slotHeight;
