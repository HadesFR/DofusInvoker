package
{
   ...
   public class DofusClientMain extends Sprite implements IDofus
   {
      ...
      public function DofusClientMain()
      {
         ...
         BuildInfos.VERSION = new Version("2.58.1-release",buildType.toUpperCase() == "LOCAL"?BuildTypeEnum.INTERNAL:BuildTypeEnum[buildType.toUpperCase()]);
         BuildInfos.BUILD_DATE = "21-12-2020 13:42";
         try
         {
