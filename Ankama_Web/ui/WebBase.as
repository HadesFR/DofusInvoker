package Ankama_Web.ui
{
   ...
   public class WebBase
   {
      ...
      public function main(oParams:* = null) : void
      {
         ...
         currentTabUi = null;
         if(this.sysApi.getCurrentServer().gameTypeId == GameServerTypeEnum.SERVER_TYPE_TEMPORIS || this.sysApi.getCurrentServer().gameTypeId == GameServerTypeEnum.SERVER_TYPE_HARDCORE)
         {
