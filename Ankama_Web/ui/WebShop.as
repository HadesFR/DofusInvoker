package Ankama_Web.ui
{
   ...
   public class WebShop
   {
      ...
      private var _shopArticle:ShopArticle#476 = null;
      ...
      public function main(oParam:Object = null) : void
      {
         ...
         this.sysApi.addHook(ExternalGameHookList.DofusShopOneClickTokens,this.onDofusShopOneClickTokens);
      ...
      public function updateSlot(data:*, componentsRef:*, selected:Boolean, line:uint) : void
      {
         ...
         var labelOneClick:Label = null;
         var labelOldOneClick:Label = null;
         var btn:ButtonContainer = null;
         var btnBuy:ButtonContainer = null;
         var btnBuyOneClick:ButtonContainer = null;
         ...
         var oneClickBg:TextureBitmap = null;
      ...
      private function getShopArticle(dsa:*) : ShopArticle#476
      {
         var sa:ShopArticle = null;
         var i:int = 0;
         ...
         sa = new ShopArticle#476(dsa is DofusShopArticle?dsa:null);
         if(!dsa)
         {
            return sa;
         }
      ...
      private function displayArticle(shopArticle:ShopArticle#476) : void
      {
      ...
      private function getFanion(article:ShopArticle#476) : Fanion
      {
...
class ShopArticle#476
{
   ...
   function ShopArticle#476(dsa:DofusShopArticle)
   {
      super();
      this.article = dsa;
