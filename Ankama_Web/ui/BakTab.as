package Ankama_Web.ui
{
   ...
   public class BakTab
   {
      ...
      private var kamasTransferTimer:Timer;
      
      private var offersRefreshTimer:Timer;
      ...
      public function main(oParam:Object = null) : void
      {
         ...
         this.kamasTransferTimer = new Timer(500,1);
      ...
      private function onDofusBakLinkedOgrines(ogrinesList:Object) : void
      {
         ...
         for each(ogrines in ogrinesList)
         {
            ...
            this._ogrinesAmount = this._ogrinesAmount + amount;
            if(ogrines.forbidden_usages != "")
            {
               this._linkedOgrinesAmount = this._linkedOgrinesAmount + amount;
      ...
      private function onDofusBakKamasBufferList(buffers:Vector.<BufferInformation>) : void
      {
         ...
         {
            bufferedKamas = bufferedKamas + buffer.amount;
         }
      ...
      private function selectBuyOgrinesTab() : void
      {
         ...
         if(this.blk_ogrinesOffersGridBlock.x > this.blk_kamasOffersGridBlock.x)
         {
            ...
            this.blk_ogrinesOffersGridBlock.x = this.blk_ogrinesOffersGridBlock.x - diff;
            this.lbl_ogrinesOffersGrid.x = this.lbl_ogrinesOffersGrid.x - diff;
            this.blk_kamasOffersGridBlock.x = this.blk_kamasOffersGridBlock.x + diff;
            this.lbl_kamasOffersGrid.x = this.lbl_kamasOffersGrid.x + diff;
         }
